    ...
    return (
        <footer className="w-full bg-background text-center p-6 mt-auto">
            <div className="max-w-4xl mx-auto text-xs text-text-muted space-y-2">
                ...
                <button
                    onClick={onThemesClick} // Calls the function passed down from the parent
                    className="text-text-muted hover:text-primary font-semibold py-2 px-4 rounded-lg transition-colors"
                >
                    Change Themes
                </button>
            </div>
